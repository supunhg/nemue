...
pub fn http_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: openresty/(\d+\.\d+\.\d+)",
            "OpenResty",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Tengine/(\d+\.\d+\.\d+)",
            "Tengine",
            Some("$1"),
        ),
        // Microsoft IIS
        ...
        m(
            "http",
            r"Server: lighttpd/(\d+\.\d+\.\d+)",
            "lighttpd",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: lighttpd/(\d+\.\d+)",
            "lighttpd",
            Some("$1"),
        ),
        // LiteSpeed
        m(
            "http",
            r"Server: LiteSpeed/(\d+)",
            "LiteSpeed httpd",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: OpenLiteSpeed/(\d+\.\d+)",
            "OpenLiteSpeed",
            Some("$1"),
        ),
        // Caddy
        ...
        m(
            "http",
            r"Server: BaseHTTP/(\d+\.\d+) Python/(\d+\.\d+\.\d+)",
            "Python BaseHTTP",
            Some("$2"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Frame-Options: DENY.*Server: WSGIServer",
            "Django",
            None,
        ),
        ...
        m(
            "http",
            r"X-Served-By: cache-.*\.fastly\.net",
            "Fastly CDN",
            None,
        ),
...
pub fn ssh_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "ssh",
            r"SSH-2.0-PuTTY_Release_([\d.]+)",
            "PuTTY SSH",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-Windows Power",
            "Microsoft Windows SSH",
            None,
        ),
        m(
            "ssh",
            r"SSH-2.0-paramiko_([\d.]+)",
            "Paramiko SSH",
            Some("$1"),
        ),
        ...
        m(
            "ssh",
            r"SSH-2.0-Apache-SSHD-([\d.]+)",
            "Apache SSHD",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) FreeBSD",
            "OpenSSH (FreeBSD)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) Ubuntu",
            "OpenSSH (Ubuntu)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) Debian",
            "OpenSSH (Debian)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) RHEL",
            "OpenSSH (RHEL)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) CentOS",
            "OpenSSH (CentOS)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) SUSE",
            "OpenSSH (SUSE)",
            Some("$1"),
        ),
        m(
        ...
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) NetBSD",
            "OpenSSH (NetBSD)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) OpenBSD",
            "OpenSSH (OpenBSD)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) Apple",
            "OpenSSH (macOS)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*QNAP",
            "OpenSSH (QNAP NAS)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*Synology",
            "OpenSSH (Synology NAS)",
            Some("$1"),
        ),
        m("ssh", r"SSH-2.0-ROSSSH", "MikroTik SSH", None),
...
pub fn dns_signatures() -> Vec<MatchPattern> {
    vec![
        m(
            "dns",
            r"version\.bind.*BIND (\d+\.\d+\.\d+)",
            "ISC BIND",
            Some("$1"),
        ),
        m(
            "dns",
            r"version\.bind.*BIND (\d+\.\d+)",
            "ISC BIND",
            Some("$1"),
        ),
        ...
        m(
            "dns",
            r"version\.bind.*Microsoft DNS",
            "Microsoft DNS",
            None,
        ),
        m(
            "dns",
            r"version\.bind.*Unbound (\d+\.\d+\.\d+)",
            "Unbound",
            Some("$1"),
        ),
...
pub fn http_frameworks_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: Vert\.x-Web/(\d+\.\d+\.\d+)",
            "Vert.x-Web",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Vert\.x HTTP Server",
            "Vert.x HTTP Server",
            None,
        ),
        ...
        m(
            "http",
            r"Server: Werkzeug/(\d+\.\d+\.\d+) Python/(\d+\.\d+\.\d+)",
            "Flask",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"Server: Python/(\d+\.\d+) aiohttp/(\d+\.\d+\.\d+)",
            "aiohttp",
            Some("$2"),
        ),
        // Apache Struts
...
pub fn reverse_proxy_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: nginx/(\d+\.\d+\.\d+).*mod",
            "nginx (modified)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: nginx-unit/(\d+\.\d+\.\d+)",
            "NGINX Unit",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: ApacheTrafficServer",
            "Apache Traffic Server",
            None,
        ),
        m(
            "http",
            r"Via:.*ApacheTrafficServer",
            "Apache Traffic Server",
            None,
        ),
        // Envoy variants
        ...
        m(
            "http",
            r"Server: Microsoft-Azure-Application-Gateway",
            "Azure App GW",
            None,
        ),
    ]
...
pub fn api_gateway_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"X-Powered-By: Express Gateway",
            "Express Gateway",
            None,
        ),
        // Zuul
...
pub fn ssh_vendor_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "ssh",
            r"SSH-2.0-Extreme Networks",
            "Extreme Networks SSH",
            None,
        ),
        ...
        m(
            "ssh",
            r"SSH-2.0-EdgeRouter",
            "Ubiquiti EdgeRouter SSH",
            None,
        ),
        // Dell Networking (extra)
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_.*Dell",
            "Dell Networking SSH",
            None,
        ),
...
pub fn ssh_os_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) AlmaLinux",
            "OpenSSH (AlmaLinux)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*alma",
            "OpenSSH (AlmaLinux)",
            Some("$1"),
        ),
        // Rocky Linux
        ...
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*amzn",
            "OpenSSH (Amazon Linux)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) Amazon",
            "OpenSSH (Amazon Linux)",
            Some("$1"),
        ),
        // Oracle Linux
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*Oracle",
            "OpenSSH (Oracle Linux)",
            Some("$1"),
        ),
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*el.*uek",
            "OpenSSH (Oracle UEK)",
            Some("$1"),
        ),
        // Arch Linux
        ...
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*alpine",
            "OpenSSH (Alpine Linux)",
            Some("$1"),
        ),
        // Manjaro
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*manjaro",
            "OpenSSH (Manjaro)",
            Some("$1"),
        ),
        // Fedora
        ...
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*cloudlinux",
            "OpenSSH (CloudLinux)",
            Some("$1"),
        ),
        // AIX
        ...
        m(
            "ssh",
            r"SSH-2.0-OpenSSH_([\d.]+) .*joyent",
            "OpenSSH (SmartOS/Joyent)",
            Some("$1"),
        ),
    ]
}
...
pub fn ftp_extended_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "ftp",
            r"220.*vsFTPd (\d+\.\d+\.\d+).*Ubuntu",
            "vsftpd (Ubuntu)",
            Some("$1"),
        ),
        m(
            "ftp",
            r"220.*vsFTPd (\d+\.\d+\.\d+).*Debian",
            "vsftpd (Debian)",
            Some("$1"),
        ),
        // FileZilla variants
...
pub fn smtp_extended_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "smtp",
            r"220.*\.google\.com ESMTP",
            "Google Workspace SMTP",
            None,
        ),
        m(
            "smtp",
            r"220.*smtp\.google\.com",
            "Google Workspace SMTP",
            None,
        ),
        // Amazon SES
        m(
            "smtp",
            r"220.*email-smtp\.amazonaws\.com",
            "Amazon SES",
            None,
        ),
        // Mailgun
...
pub fn game_media_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: Wowza Streaming Engine",
            "Wowza Streaming",
            None,
        ),
...
pub fn web_server_framework_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+).*mod_security",
            "Apache mod_security",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache.*mod_security",
            "Apache mod_security",
            None,
        ),
        ...
        m(
            "http",
            r"Server: Apache.*mod_fastcgi",
            "Apache mod_fastcgi",
            None,
        ),
        m(
            "http",
            r"Server: Apache.*mod_fcgid",
            "Apache mod_fcgid",
            None,
        ),
        ...
        m(
            "http",
            r"Server: Apache.*mod_proxy",
            "Apache mod_proxy",
            None,
        ),
        m(
            "http",
            r"Server: Apache.*mod_pagespeed",
        ...
        m(
            "http",
            r"Server: Microsoft-IIS/10\.0",
            "Microsoft IIS 10.0",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/8\.5",
            "Microsoft IIS 8.5",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/8\.0",
            "Microsoft IIS 8.0",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/7\.5",
            "Microsoft IIS 7.5",
            None,
        ),
        m(
        ...
        m(
            "http",
            r"Server: GlassFish Server (\d+\.\d+)",
            "GlassFish",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: WebSphere Application Server",
            "IBM WebSphere",
            None,
        ),
        ...
        m(
            "http",
            r"Server: Oracle-Application-Server",
            "Oracle App Server",
            None,
        ),
        m(
            "http",
            r"Server: Oracle-HTTP-Server",
            "Oracle HTTP Server",
            None,
        ),
        ...
        m(
            "http",
            r"Server: Unicorn (\d+\.\d+\.\d+)",
            "Unicorn",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Passenger (\d+\.\d+\.\d+)",
            "Passenger",
            Some("$1"),
        ),
        m(
...
pub fn database_more_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "mysql",
            r"(\d+\.\d+\.\d+)-MariaDB-.*Ubuntu",
            "MariaDB (Ubuntu)",
            Some("$1"),
        ),
        m(
            "mysql",
            r"(\d+\.\d+\.\d+)-MariaDB-.*Debian",
            "MariaDB (Debian)",
            Some("$1"),
        ),
        m(
            "mysql",
            r"(\d+\.\d+\.\d+)-MariaDB-.*CentOS",
            "MariaDB (CentOS)",
            Some("$1"),
        ),
        m("mysql", r"(\d+\.\d+\.\d+)-MariaDB", "MariaDB", Some("$1")),
        ...
        m(
            "redis",
            r"Redis server v=(\d+\.\d+\.\d+)",
            "Redis",
            Some("$1"),
        ),
        m(
            "redis",
            r"redis_version:(\d+\.\d+\.\d+).*valkey",
            "Valkey",
            Some("$1"),
        ),
...
pub fn mail_more_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "smtp",
            r"220.*Exchange Server (\d+)",
            "Microsoft Exchange",
            Some("$1"),
        ),
        m(
            "imap",
            r"Microsoft Exchange IMAP4",
            "Microsoft Exchange IMAP",
            None,
        ),
        m(
            "pop3",
            r"Microsoft Exchange POP3",
            "Microsoft Exchange POP3",
            None,
        ),
        m(
        ...
        m(
            "smtp",
            r"220.*Postfix.*Amazon",
            "Postfix (Amazon Linux)",
            None,
        ),
        // Exim variants
        m("smtp", r"220.*Exim (\d+\.\d+\.\d+)", "Exim", Some("$1")),
...
pub fn web_frameworks_extra_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"X-Content-Type-Options:.*Server:.*WSGIServer",
            "Django",
            None,
        ),
        // Flask extra
        m(
            "http",
            r"Server: Werkzeug/(\d+\.\d+) Python/(\d+\.\d+)",
            "Flask",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Flask/(\d+\.\d+)",
            "Flask",
            Some("$1"),
        ),
        m(
            "http",
            r"Set-Cookie:.*session=.*httponly.*Secure",
            "Flask",
            None,
        ),
        m(
            "http",
            r"Server: CherryPy/(\d+\.\d+) Python/(\d+\.\d+)",
            "CherryPy",
            Some("$1"),
        ),
        // FastAPI extra
        m(
            "http",
            r"Server: uvicorn/(\d+\.\d+) Python/(\d+\.\d+)",
            "FastAPI/uvicorn",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"Server: Phusion Passenger/(\d+\.\d+)",
            "Phusion Passenger",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Phusion Passenger/(\d+\.\d+)",
            "Phusion Passenger",
            Some("$1"),
        ),
        // Grape
        ...
        m(
            "http",
            r"X-Powered-By: CodeIgniter/(\d+\.\d+)",
            "CodeIgniter",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"X-Powered-By: Zend Framework/(\d+\.\d+)",
            "Zend Framework",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Laminas/(\d+\.\d+)",
            "Laminas",
            Some("$1"),
        ),
        // Yii
        ...
        m(
            "http",
            r"X-Powered-By: Nette Framework",
            "Nette Framework",
            None,
        ),
        m(
            "http",
            r"Set-Cookie:.*nette-browser",
            "Nette Framework",
            None,
        ),
        // October CMS
        ...
        m(
            "http",
            r"X-Application-Context:.*Spring",
            "Spring Boot",
            None,
        ),
        ...
        m(
            "http",
            r"Server: Apache-Coyote/(\d+\.\d+)",
            "Apache Tomcat",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring/(\d+\.\d+)",
            "Spring Framework",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/(\d+\.\d+)",
            "Spring Boot",
            Some("$1"),
        ),
        // Struts extra
        ...
        m(
            "http",
            r"Server: Vert\.x-Web/(\d+\.\d+)",
            "Vert.x-Web",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Vert\.x/(\d+\.\d+)",
            "Vert.x",
            Some("$1"),
        ),
        // Micronaut extra
        ...
        m(
            "http",
            r"Server: Dropwizard/(\d+\.\d+)",
            "Dropwizard",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Dropwizard/(\d+\.\d+)",
            "Dropwizard",
            Some("$1"),
        ),
        // Grails extra
        ...
        m(
            "http",
            r"Server: Microsoft-IIS/(\d+\.\d+).*ASP\.NET",
            "ASP.NET Core",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET Core/(\d+\.\d+)",
            "ASP.NET Core",
            Some("$1"),
        ),
        // Nancy
...
pub fn database_variants_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "mysql",
            r"Percona Server.*(\d+\.\d+\.\d+)",
            "Percona Server",
            Some("$1"),
        ),
        m(
            "mysql",
            r"Percona XtraDB Cluster",
        ...
        m(
            "mysql",
            r"(\d+\.\d+\.\d+)-MariaDB-.*MariaDB Server",
            "MariaDB",
            Some("$1"),
        ),
        // Aurora extra
        ...
        m(
            "postgres",
            r"Amazon Aurora PostgreSQL",
            "Amazon Aurora PostgreSQL",
            None,
        ),
        m(
            "postgres",
            r"Aurora PostgreSQL (\d+\.\d+)",
            "Amazon Aurora PostgreSQL",
            Some("$1"),
        ),
        // MongoDB extra
        m(
            "mongodb",
            r"MongoDB (\d+\.\d+\.\d+).*replica set",
            "MongoDB Replica Set",
            Some("$1"),
        ),
        m(
            "mongodb",
            r"MongoDB (\d+\.\d+\.\d+).*sharded",
            "MongoDB Sharded",
            Some("$1"),
        ),
        ...
        m(
            "mongodb",
            r"Percona Server for MongoDB (\d+\.\d+)",
            "Percona MongoDB",
            Some("$1"),
        ),
        // KeyDB extra
        ...
        m(
            "elasticsearch",
            r"elasticsearch/(\d+\.\d+\.\d+).*cluster",
            "Elasticsearch",
            Some("$1"),
        ),
        m(
            "elasticsearch",
            r"You Know, for Search",
            "Elasticsearch",
            None,
        ),
        m(
            "elasticsearch",
            r"tagline.*elasticsearch",
            "Elasticsearch",
            None,
        ),
        m(
            "http",
            r"X-elastic-product: Elasticsearch",
            "Elasticsearch",
            None,
        ),
        // OpenSearch extra
        ...
        m(
            "clickhouse",
            r"ClickHouse server version (\d+\.\d+\.\d+)",
            "ClickHouse",
            Some("$1"),
        ),
...
pub fn network_equip_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "telnet",
            r"Cisco IOS Software,.*Version (\d+\.\d+)",
            "Cisco IOS",
            Some("$1"),
        ),
        m(
        ...
        m(
            "telnet",
            r"Juniper Networks.*JUNOS Software",
            "Juniper Junos",
            None,
        ),
        ...
        m(
            "ssh",
            r"SSH-2.0-SSH_.*VRP (\d+\.\d+)",
            "Huawei VRP",
            Some("$1"),
        ),
        m(
            "telnet",
            r"Huawei.*VRP.*Version (\d+\.\d+)",
            "Huawei VRP",
            Some("$1"),
        ),
        ...
        m(
            "ssh",
            r"SSH-2.0-ROSSSH.*(\d+\.\d+)",
            "MikroTik RouterOS",
            Some("$1"),
        ),
        m(
            "telnet",
            r"MikroTik.*RouterOS (\d+\.\d+)",
            "MikroTik RouterOS",
            Some("$1"),
        ),
        m(
        ...
        m(
            "ssh",
            r"SSH-2.0-Barracuda.*(\d+\.\d+)",
            "Barracuda",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: BarracudaHTTP/(\d+)",
            "Barracuda",
            Some("$1"),
        ),
        m(
...
pub fn iot_devices_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Allen-Bradley.*MicroLogix",
            "Allen-Bradley MicroLogix",
            None,
        ),
        m(
            "http",
            r"Allen-Bradley.*CompactLogix",
            "Allen-Bradley CompactLogix",
            None,
        ),
        m(
            "http",
            r"Allen-Bradley.*ControlLogix",
            "Allen-Bradley ControlLogix",
            None,
        ),
        m(
            "http",
            r"Rockwell.*CompactLogix",
            "Rockwell CompactLogix",
            None,
        ),
        m(
            "http",
            r"Rockwell.*ControlLogix",
        ...
        m(
            "http",
            r"Schneider.*Modicon M\d+",
            "Schneider Modicon M",
            None,
        ),
        m(
            "http",
            r"Schneider.*Modicon TM\d+",
            "Schneider Modicon TM",
            None,
        ),
        m(
            "http",
            r"Schneider.*PowerLogic",
            "Schneider PowerLogic",
            None,
        ),
        m(
            "http",
            r"Schneider.*EcoStruxure",
...
pub fn version_specific_web_server_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+)",
            "Apache httpd",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+)",
            "Apache httpd",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+)",
            "Apache httpd",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache/1\.3\.(\d+)",
            "Apache httpd",
            Some("1.3.$1"),
        ),
        m(
            "http",
            r"Server: Apache/1\.2\.(\d+)",
            "Apache httpd",
            Some("1.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/1\.1\.(\d+)",
            "Apache httpd",
            Some("1.1.$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+)-Win",
            "Apache httpd (Windows)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+) \(Unix\)",
            "Apache httpd (Unix)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+) \(Debian\)",
            "Apache httpd (Debian)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+) \(Ubuntu\)",
            "Apache httpd (Ubuntu)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+) \(CentOS\)",
            "Apache httpd (CentOS)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+) \(Red Hat\)",
            "Apache httpd (RHEL)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+) \(FreeBSD\)",
            "Apache httpd (FreeBSD)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+) \(Debian\).*mod_ssl",
            "Apache httpd (Debian/mod_ssl)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+).*OpenSSL",
            "Apache httpd (OpenSSL)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+).*PHP",
            "Apache httpd (PHP)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache/(\d+\.\d+\.\d+).*Perl",
            "Apache httpd (Perl)",
            Some("$1"),
        ),
        // Nginx versions
        m(
            "http",
            r"Server: nginx/1\.25\.(\d+)",
            "nginx",
            Some("1.25.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.24\.(\d+)",
            "nginx",
            Some("1.24.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.23\.(\d+)",
            "nginx",
            Some("1.23.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.22\.(\d+)",
            "nginx",
            Some("1.22.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.21\.(\d+)",
            "nginx",
            Some("1.21.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.20\.(\d+)",
            "nginx",
            Some("1.20.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.19\.(\d+)",
            "nginx",
            Some("1.19.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.18\.(\d+)",
            "nginx",
            Some("1.18.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.17\.(\d+)",
            "nginx",
            Some("1.17.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.16\.(\d+)",
            "nginx",
            Some("1.16.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.15\.(\d+)",
            "nginx",
            Some("1.15.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.14\.(\d+)",
            "nginx",
            Some("1.14.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.13\.(\d+)",
            "nginx",
            Some("1.13.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.12\.(\d+)",
            "nginx",
            Some("1.12.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.10\.(\d+)",
            "nginx",
            Some("1.10.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.8\.(\d+)",
            "nginx",
            Some("1.8.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.6\.(\d+)",
            "nginx",
            Some("1.6.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.4\.(\d+)",
            "nginx",
            Some("1.4.$1"),
        ),
        m(
            "http",
            r"Server: nginx/(\d+\.\d+\.\d+).*Ubuntu",
            "nginx (Ubuntu)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: nginx/(\d+\.\d+\.\d+).*Debian",
            "nginx (Debian)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: nginx/(\d+\.\d+\.\d+).*CentOS",
            "nginx (CentOS)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: nginx/(\d+\.\d+\.\d+).*Win",
            "nginx (Windows)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: nginx/(\d+\.\d+\.\d+).*brotli",
            "nginx (brotli)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: nginx/(\d+\.\d+\.\d+).*http2",
            "nginx (HTTP/2)",
            Some("$1"),
        ),
        // IIS versions
        ...
        m(
            "http",
            r"Server: Microsoft-IIS/5\.1",
            "Microsoft IIS 5.1",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/5\.0",
            "Microsoft IIS 5.0",
            None,
        ),
        m(
        ...
        m(
            "http",
            r"Server: Microsoft-IIS/3\.0",
            "Microsoft IIS 3.0",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/2\.0",
            "Microsoft IIS 2.0",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/1\.0",
            "Microsoft IIS 1.0",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/10\.0.*ASP\.NET",
            "Microsoft IIS 10.0 (ASP.NET)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/8\.5.*ASP\.NET",
        ...
        m(
            "http",
            r"Server: Apache Tomcat/10\.(\d+)",
            "Apache Tomcat",
            Some("10.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/9\.(\d+)",
            "Apache Tomcat",
            Some("9.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/8\.5\.(\d+)",
            "Apache Tomcat",
            Some("8.5.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/8\.0\.(\d+)",
            "Apache Tomcat",
            Some("8.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/7\.0\.(\d+)",
            "Apache Tomcat",
            Some("7.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/6\.0\.(\d+)",
            "Apache Tomcat",
            Some("6.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/5\.5\.(\d+)",
            "Apache Tomcat",
            Some("5.5.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/5\.0\.(\d+)",
            "Apache Tomcat",
            Some("5.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/4\.1\.(\d+)",
            "Apache Tomcat",
            Some("4.1.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/3\.(\d+)",
            "Apache Tomcat",
            Some("3.$1"),
        ),
        m(
            "http",
            r"Server: Apache-Coyote/1\.1",
            "Apache Tomcat Coyote 1.1",
            None,
        ),
        m(
            "http",
            r"Server: Apache-Coyote/1\.0",
            "Apache Tomcat Coyote 1.0",
            None,
        ),
        // Jetty versions
        m(
        ...
        m(
            "http",
            r"Server: Jetty \(9\.4\.(\d+)\)",
            "Jetty",
            Some("9.4.$1"),
        ),
        m(
            "http",
            r"Server: Jetty \(9\.3\.(\d+)\)",
            "Jetty",
            Some("9.3.$1"),
        ),
        m(
            "http",
            r"Server: Jetty \(9\.2\.(\d+)\)",
            "Jetty",
            Some("9.2.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Jetty \(11\.0\.(\d+)\)",
            "Jetty",
            Some("11.0.$1"),
        ),
        m(
            "http",
            r"Server: Jetty \(12\.0\.(\d+)\)",
            "Jetty",
            Some("12.0.$1"),
        ),
        // Caddy versions
        ...
        m(
            "http",
            r"Server: LiteSpeed/(\d+\.\d+\.\d+)",
            "LiteSpeed httpd",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: LiteSpeed/(\d+\.\d+)",
            "LiteSpeed httpd",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: LiteSpeed Web Server",
            "LiteSpeed httpd",
            None,
        ),
        m(
            "http",
            r"Server: LiteSpeed/(\d+\.\d+\.\d+) Enterprise",
        ...
        m(
            "http",
            r"Server: Cherokee/(\d+\.\d+\.\d+)",
            "Cherokee httpd",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Cherokee/(\d+\.\d+)",
            "Cherokee httpd",
            Some("$1"),
        ),
...
pub fn version_specific_app_server_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: WebLogic Server (\d+\.\d+\.\d+)",
            "Oracle WebLogic",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: WebLogic Server (\d+\.\d+)",
            "Oracle WebLogic",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"Server: WebLogic Server (\d+) ",
            "Oracle WebLogic",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: WebLogic/(\d+\.\d+)",
            "Oracle WebLogic",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"Server: WebSphere Application Server/(\d+\.\d+)",
            "IBM WebSphere",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: IBM WebSphere Application Server",
            "IBM WebSphere",
            None,
        ),
        m("http", r"Server: WebSphere", "IBM WebSphere", None),
        m(
            "http",
            r"Server: IBM_HTTP_Server/(\d+\.\d+\.\d+)",
            "IBM HTTP Server",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: IBM_HTTP_Server/(\d+\.\d+)",
            "IBM HTTP Server",
            Some("$1"),
        ),
        m("http", r"Server: IBM_HTTP_Server", "IBM HTTP Server", None),
        m(
            "http",
            r"X-Powered-By: Servlet.*WebSphere",
            "IBM WebSphere",
            None,
        ),
        m(
            "http",
            r"Server: WebSphere Liberty",
            "IBM WebSphere Liberty",
            None,
        ),
        m(
            "http",
            r"Server: WebSphere Application Server Liberty",
            "IBM WebSphere Liberty",
            None,
        ),
        ...
        m(
            "http",
            r"Server: GlassFish Server Open Source Edition (\d+)",
            "GlassFish",
            Some("$1"),
        ),
        m("http", r"Server: GlassFish Server", "GlassFish", None),
        ...
        m(
            "http",
            r"Server: Oracle-HTTP-Server/(\d+\.\d+)",
            "Oracle HTTP Server",
            Some("$1"),
        ),
        m(
...
pub fn version_specific_language_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"X-Powered-By: Python/(\d+\.\d+\.\d+)",
            "Python",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Python/(\d+\.\d+)",
            "Python",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"X-Python-Version: (\d+\.\d+\.\d+)",
            "Python",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Python-Version: (\d+\.\d+)",
            "Python",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: BaseHTTP/(\d+\.\d+) Python/(\d+\.\d+)",
            "Python BaseHTTP",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: SimpleHTTP/(\d+\.\d+) Python/(\d+\.\d+\.\d+)",
            "Python SimpleHTTP",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: WSGIServer/(\d+\.\d+) Python/(\d+\.\d+\.\d+)",
            "Python WSGI",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: WSGIServer/(\d+\.\d+) Python/(\d+\.\d+)",
            "Python WSGI",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: Python/3\.12\.(\d+)",
            "Python 3.12",
            Some("3.12.$1"),
        ),
        m(
            "http",
            r"Server: Python/3\.11\.(\d+)",
            "Python 3.11",
            Some("3.11.$1"),
        ),
        m(
            "http",
            r"Server: Python/3\.10\.(\d+)",
            "Python 3.10",
            Some("3.10.$1"),
        ),
        m(
            "http",
            r"Server: Python/3\.9\.(\d+)",
            "Python 3.9",
            Some("3.9.$1"),
        ),
        m(
            "http",
            r"Server: Python/3\.8\.(\d+)",
            "Python 3.8",
            Some("3.8.$1"),
        ),
        m(
            "http",
            r"Server: Python/3\.7\.(\d+)",
            "Python 3.7",
            Some("3.7.$1"),
        ),
        m(
            "http",
            r"Server: Python/2\.7\.(\d+)",
            "Python 2.7",
            Some("2.7.$1"),
        ),
        m(
            "http",
            r"Server: Python/2\.6\.(\d+)",
            "Python 2.6",
            Some("2.6.$1"),
        ),
        // Node.js versions
        ...
        m(
            "http",
            r"Server: Node\.js/(\d+\.\d+)",
            "Node.js",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Node\.js/(\d+\.\d+\.\d+)",
            "Node.js",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Node\.js/(\d+\.\d+)",
            "Node.js",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"Server: WEBrick/(\d+\.\d+\.\d+) Ruby/(\d+\.\d+\.\d+)",
            "Ruby WEBrick",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: Puma (\d+\.\d+\.\d+) Ruby/(\d+\.\d+)",
            "Ruby Puma",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: thin (\d+\.\d+\.\d+) Ruby/(\d+\.\d+)",
            "Ruby Thin",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: unicorn (\d+\.\d+\.\d+) Ruby/(\d+\.\d+)",
            "Ruby Unicorn",
            Some("$2"),
        ),
        m(
            "http",
            r"Server: Mongrel (\d+\.\d+\.\d+) Ruby/(\d+\.\d+)",
            "Ruby Mongrel",
            Some("$2"),
        ),
        // PHP versions
        ...
        m(
            "http",
            r"X-Powered-By: PHP/8\.3\.(\d+)",
            "PHP 8.3",
            Some("8.3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/8\.2\.(\d+)",
            "PHP 8.2",
            Some("8.2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/8\.1\.(\d+)",
            "PHP 8.1",
            Some("8.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/8\.0\.(\d+)",
            "PHP 8.0",
            Some("8.0.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/7\.4\.(\d+)",
            "PHP 7.4",
            Some("7.4.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/7\.3\.(\d+)",
            "PHP 7.3",
            Some("7.3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/7\.2\.(\d+)",
            "PHP 7.2",
            Some("7.2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/7\.1\.(\d+)",
            "PHP 7.1",
            Some("7.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/7\.0\.(\d+)",
            "PHP 7.0",
            Some("7.0.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/5\.6\.(\d+)",
            "PHP 5.6",
            Some("5.6.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/5\.5\.(\d+)",
            "PHP 5.5",
            Some("5.5.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/5\.4\.(\d+)",
            "PHP 5.4",
            Some("5.4.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/5\.3\.(\d+)",
            "PHP 5.3",
            Some("5.3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: PHP/5\.2\.(\d+)",
            "PHP 5.2",
            Some("5.2.$1"),
        ),
        // Java versions
        ...
        m(
            "http",
            r"Server: Jetty.*Java/(\d+\.\d+)",
            "Java (Jetty)",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Apache-Coyote.*Java/(\d+\.\d+)",
            "Java (Tomcat)",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"Server: Kestrel/(\d+\.\d+)",
            "ASP.NET Kestrel",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET/(\d+\.\d+)",
            "ASP.NET",
            Some("$1"),
        ),
        // Perl
...
pub fn version_specific_framework_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: Django/4\.2\.(\d+)",
            "Django 4.2",
            Some("4.2.$1"),
        ),
        m(
            "http",
            r"Server: Django/4\.1\.(\d+)",
            "Django 4.1",
            Some("4.1.$1"),
        ),
        m(
            "http",
            r"Server: Django/4\.0\.(\d+)",
            "Django 4.0",
            Some("4.0.$1"),
        ),
        m(
            "http",
            r"Server: Django/3\.2\.(\d+)",
            "Django 3.2",
            Some("3.2.$1"),
        ),
        m(
            "http",
            r"Server: Django/3\.1\.(\d+)",
            "Django 3.1",
            Some("3.1.$1"),
        ),
        m(
            "http",
            r"Server: Django/2\.2\.(\d+)",
            "Django 2.2",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Django/2\.1\.(\d+)",
            "Django 2.1",
            Some("2.1.$1"),
        ),
        m(
            "http",
            r"Server: Django/1\.11\.(\d+)",
            "Django 1.11",
            Some("1.11.$1"),
        ),
        // Flask versions
        ...
        m(
            "http",
            r"Server: Werkzeug/(\d+\.\d+\.\d+) Python/(\d+\.\d+)",
            "Flask",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Express/4\.(\d+)",
            "Express.js 4",
            Some("4.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Express/3\.(\d+)",
            "Express.js 3",
            Some("3.$1"),
        ),
        // Rails versions
        ...
        m(
            "http",
            r"X-Powered-By: Rails/(\d+\.\d+\.\d+)",
            "Ruby on Rails",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Rails/(\d+\.\d+)",
            "Ruby on Rails",
            Some("$1"),
        ),
        m("http", r"Set-Cookie:.*_session_id", "Ruby on Rails", None),
        ...
        m(
            "http",
            r"Server: Passenger.*Rails",
            "Ruby on Rails (Passenger)",
            None,
        ),
        m(
            "http",
            r"Server: Unicorn.*Rails",
        ...
        m(
            "http",
            r"X-Powered-By: Spring Boot/(\d+\.\d+\.\d+)",
            "Spring Boot",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Spring Boot/3\.(\d+)",
            "Spring Boot 3",
            Some("3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.(\d+)",
            "Spring Boot 2",
            Some("2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/1\.(\d+)",
            "Spring Boot 1",
            Some("1.$1"),
        ),
        // ASP.NET versions
        ...
        m(
            "http",
            r"Server: Microsoft-IIS.*ASP\.NET",
            "ASP.NET (IIS)",
            None,
        ),
        ...
        m(
            "http",
            r"X-Powered-By: CodeIgniter/(\d+\.\d+\.\d+)",
            "CodeIgniter",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Zend Framework/(\d+\.\d+\.\d+)",
            "Zend Framework",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Zend Framework",
            "Zend Framework",
            None,
        ),
        m(
            "http",
            r"X-Powered-By: Laminas/(\d+\.\d+\.\d+)",
            "Laminas",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Next\.js/(\d+\.\d+\.\d+)",
            "Next.js",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Next\.js/(\d+\.\d+)",
            "Next.js",
            Some("$1"),
        ),
        // Nuxt.js versions
        ...
        m(
            "http",
            r"X-Powered-By: Nuxt/(\d+\.\d+\.\d+)",
            "Nuxt.js",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Nuxt/(\d+\.\d+)",
            "Nuxt.js",
            Some("$1"),
        ),
        m("http", r"nuxt/", "Nuxt.js", None),
        ...
        m(
            "http",
            r"X-Powered-By: Dropwizard/(\d+\.\d+\.\d+)",
            "Dropwizard",
            Some("$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Mojolicious/(\d+\.\d+)",
            "Mojolicious",
            Some("$1"),
        ),
        m("http", r"X-Powered-By: Mojolicious", "Mojolicious", None),
        ...
        m(
            "http",
            r"X-Powered-By: Perl Dancer/(\d+\.\d+\.\d+)",
            "Perl Dancer",
            Some("$1"),
        ),
        m("http", r"X-Powered-By: Perl Dancer", "Perl Dancer", None),
        ...
        m(
            "http",
            r"X-Powered-By: Sails.js/(\d+\.\d+\.\d+)",
            "Sails.js",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Sails.js/(\d+\.\d+)",
            "Sails.js",
            Some("$1"),
        ),
        m("http", r"X-Powered-By: Sails.js", "Sails.js", None),
        ...
        m(
            "http",
            r"X-Powered-By: AdonisJs/(\d+\.\d+\.\d+)",
            "AdonisJS",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: AdonisJs/(\d+\.\d+)",
            "AdonisJS",
            Some("$1"),
        ),
        m("http", r"X-Powered-By: AdonisJs", "AdonisJS", None),
        ...
        m(
            "http",
            r"X-Powered-By: LoopBack/(\d+\.\d+\.\d+)",
            "LoopBack",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: LoopBack/(\d+\.\d+)",
            "LoopBack",
            Some("$1"),
        ),
        m("http", r"X-Powered-By: LoopBack", "LoopBack", None),
        ...
        m(
            "http",
            r"X-Powered-By: Strapi/(\d+\.\d+\.\d+)",
            "Strapi",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Strapi/(\d+\.\d+)",
            "Strapi",
            Some("$1"),
        ),
        m("http", r"X-Powered-By: Strapi", "Strapi", None),
        ...
        m(
            "http",
            r"Server: Starlette/(\d+\.\d+\.\d+)",
            "Starlette",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Starlette/(\d+\.\d+)",
            "Starlette",
            Some("$1"),
        ),
        m("http", r"Server: Starlette", "Starlette", None),
        ...
        m(
            "http",
            r"X-Powered-By: Falcon/(\d+\.\d+\.\d+)",
            "Falcon",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Falcon/(\d+\.\d+)",
            "Falcon",
            Some("$1"),
        ),
        m("http", r"X-Powered-By: Falcon", "Falcon", None),
        ...
        m(
            "http",
            r"Server: Mongoose/(\d+\.\d+\.\d+)",
            "Mongoose HTTP",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Mongoose/(\d+\.\d+)",
            "Mongoose HTTP",
            Some("$1"),
        ),
        m("http", r"Server: Mongoose", "Mongoose HTTP", None),
        ...
        m(
            "http",
            r"Server: mini_httpd/(\d+\.\d+\d+)",
            "mini_httpd",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: mini_httpd/(\d+\.\d+)",
            "mini_httpd",
            Some("$1"),
        ),
        m("http", r"Server: mini_httpd", "mini_httpd", None),
        ...
        m(
            "http",
            r"Server: GoAhead-Webs/(\d+\.\d+\.\d+)",
            "GoAhead Web Server",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: GoAhead-Webs/(\d+\.\d+)",
            "GoAhead Web Server",
            Some("$1"),
        ),
        m("http", r"Server: GoAhead-Webs", "GoAhead Web Server", None),
...
pub fn version_specific_database_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "mysql",
            r"(\d+\.\d+\.\d+)-MySQL Community Server",
            "MySQL Community",
            Some("$1"),
        ),
        m(
        ...
        m(
            "redis",
            r"redis_version:(\d+\.\d+\.\d+).*cluster_enabled:1",
            "Redis Cluster",
            Some("$1"),
        ),
        ...
        m(
            "http",
            r"X-Amz-Target:.*DynamoDB_20120810",
            "Amazon DynamoDB",
            None,
        ),
...
pub fn cdn_extended_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"cf-cache-status: HIT",
            "Cloudflare CDN (HIT)",
            None,
        ),
        m(
            "http",
            r"cf-cache-status: MISS",
            "Cloudflare CDN (MISS)",
            None,
        ),
        m(
            "http",
            r"cf-cache-status: DYNAMIC",
            "Cloudflare CDN (DYNAMIC)",
            None,
        ),
        m(
            "http",
            r"cf-cache-status: BYPASS",
            "Cloudflare CDN (BYPASS)",
            None,
        ),
        m(
            "http",
            r"cf-cache-status: EXPIRED",
            "Cloudflare CDN (EXPIRED)",
            None,
        ),
        // Akamai variants
        ...
        m(
            "http",
            r"X-Amz-Server-Side-Encryption:",
            "AWS CloudFront/S3",
            None,
        ),
        // KeyCDN variants
...
pub fn more_version_specific_web_server_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+) \(Ubuntu\)",
            "Apache httpd 2.4 (Ubuntu)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+) \(Debian\)",
            "Apache httpd 2.4 (Debian)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+) \(CentOS\)",
            "Apache httpd 2.4 (CentOS)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+) \(Red Hat\)",
            "Apache httpd 2.4 (RHEL)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+) \(Unix\)",
            "Apache httpd 2.4 (Unix)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+) \(Win32\)",
            "Apache httpd 2.4 (Windows)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+) \(FreeBSD\)",
            "Apache httpd 2.4 (FreeBSD)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*OpenSSL/(\d+\.\d+)",
            "Apache httpd 2.4 (OpenSSL)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*PHP/(\d+\.\d+)",
            "Apache httpd 2.4 (PHP)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*mod_ssl",
            "Apache httpd 2.4 (mod_ssl)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*mod_perl",
            "Apache httpd 2.4 (mod_perl)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*mod_wsgi",
            "Apache httpd 2.4 (mod_wsgi)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*mod_fcgid",
            "Apache httpd 2.4 (mod_fcgid)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*mod_security",
            "Apache httpd 2.4 (mod_security)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*mod_evasive",
            "Apache httpd 2.4 (mod_evasive)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*Phusion_Passenger",
            "Apache httpd 2.4 (Passenger)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*Python",
            "Apache httpd 2.4 (Python)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*Ruby",
            "Apache httpd 2.4 (Ruby)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*Tomcat",
            "Apache httpd 2.4 (Tomcat)",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.4\.(\d+).*proxy",
        ...
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+) \(Ubuntu\)",
            "Apache httpd 2.2 (Ubuntu)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+) \(Debian\)",
            "Apache httpd 2.2 (Debian)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+) \(CentOS\)",
            "Apache httpd 2.2 (CentOS)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+) \(Red Hat\)",
            "Apache httpd 2.2 (RHEL)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+) \(Unix\)",
            "Apache httpd 2.2 (Unix)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+) \(Win32\)",
            "Apache httpd 2.2 (Windows)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+).*OpenSSL",
            "Apache httpd 2.2 (OpenSSL)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+).*PHP",
            "Apache httpd 2.2 (PHP)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+).*mod_ssl",
            "Apache httpd 2.2 (mod_ssl)",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.2\.(\d+).*mod_perl",
            "Apache httpd 2.2 (mod_perl)",
            Some("2.2.$1"),
        ),
        // Apache 2.0.x specific minor versions
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+) \(Win32\)",
            "Apache httpd 2.0 (Windows)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+) \(Unix\)",
            "Apache httpd 2.0 (Unix)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+) \(Debian\)",
            "Apache httpd 2.0 (Debian)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+) \(Red Hat\)",
            "Apache httpd 2.0 (RHEL)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+).*OpenSSL",
            "Apache httpd 2.0 (OpenSSL)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+).*mod_ssl",
            "Apache httpd 2.0 (mod_ssl)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache/2\.0\.(\d+).*FrontPage",
            "Apache httpd 2.0 (FrontPage)",
            Some("2.0.$1"),
        ),
        // Nginx specific minor versions with build info
        m(
            "http",
            r"Server: nginx/1\.26\.(\d+)",
            "nginx",
            Some("1.26.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.25\.(\d+).*quic",
            "nginx (QUIC)",
            Some("1.25.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.24\.(\d+) \(Ubuntu\)",
            "nginx (Ubuntu)",
            Some("1.24.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.24\.(\d+) \(Debian\)",
            "nginx (Debian)",
            Some("1.24.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.22\.(\d+) \(Ubuntu\)",
            "nginx (Ubuntu)",
            Some("1.22.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.22\.(\d+) \(Debian\)",
            "nginx (Debian)",
            Some("1.22.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.18\.(\d+) \(Ubuntu\)",
            "nginx (Ubuntu)",
            Some("1.18.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.18\.(\d+) \(Debian\)",
            "nginx (Debian)",
            Some("1.18.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.14\.(\d+) \(Ubuntu\)",
            "nginx (Ubuntu)",
            Some("1.14.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.14\.(\d+) \(Debian\)",
            "nginx (Debian)",
            Some("1.14.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.14\.(\d+) \(CentOS\)",
            "nginx (CentOS)",
            Some("1.14.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.16\.(\d+).*quic",
            "nginx (QUIC)",
            Some("1.16.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.20\.(\d+) \(Ubuntu\)",
            "nginx (Ubuntu)",
            Some("1.20.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.20\.(\d+) \(Debian\)",
            "nginx (Debian)",
            Some("1.20.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.21\.(\d+).*http2",
            "nginx (HTTP/2)",
            Some("1.21.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.23\.(\d+).*http2",
            "nginx (HTTP/2)",
            Some("1.23.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.25\.(\d+).*http2",
            "nginx (HTTP/2)",
            Some("1.25.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.26\.(\d+).*http2",
            "nginx (HTTP/2)",
            Some("1.26.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.24\.(\d+).*brotli",
            "nginx (brotli)",
            Some("1.24.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.22\.(\d+).*brotli",
            "nginx (brotli)",
            Some("1.22.$1"),
        ),
        m(
            "http",
            r"Server: nginx/1\.20\.(\d+).*brotli",
            "nginx (brotli)",
            Some("1.20.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Microsoft-IIS/10\.0.*X-Powered-By: ASP\.NET",
            "Microsoft IIS 10.0 (ASP.NET)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/8\.5.*X-Powered-By: ASP\.NET",
            "Microsoft IIS 8.5 (ASP.NET)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/8\.0.*X-Powered-By: ASP\.NET",
            "Microsoft IIS 8.0 (ASP.NET)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/7\.5.*X-Powered-By: ASP\.NET",
            "Microsoft IIS 7.5 (ASP.NET)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/7\.0.*X-Powered-By: ASP\.NET",
            "Microsoft IIS 7.0 (ASP.NET)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/6\.0.*X-Powered-By: ASP\.NET",
            "Microsoft IIS 6.0 (ASP.NET)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/10\.0.*X-Powered-By: PHP",
            "Microsoft IIS 10.0 (PHP)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/8\.5.*X-Powered-By: PHP",
            "Microsoft IIS 8.5 (PHP)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/7\.5.*X-Powered-By: PHP",
            "Microsoft IIS 7.5 (PHP)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/10\.0.*ARR",
            "Microsoft IIS 10.0 (ARR)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/8\.5.*ARR",
            "Microsoft IIS 8.5 (ARR)",
            None,
        ),
        m(
            "http",
            r"Server: Microsoft-IIS/10\.0.*UrlRewriter",
            "Microsoft IIS 10.0 (URL Rewrite)",
            None,
        ),
        // Tomcat specific minor versions
        m(
            "http",
            r"Server: Apache Tomcat/10\.1\.(\d+)",
            "Apache Tomcat",
            Some("10.1.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/10\.0\.(\d+)",
            "Apache Tomcat",
            Some("10.0.$1"),
        ),
        m(
            "http",
            r"Server: Apache Tomcat/9\.0\.(\d+)",
            "Apache Tomcat",
            Some("9.0.$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: Apache-Coyote/1\.1.*Tomcat",
            "Apache Tomcat Coyote 1.1",
            None,
        ),
        ...
        m(
            "http",
            r"Server: lighttpd/1\.4\.(\d+)",
            "lighttpd 1.4",
            Some("1.4.$1"),
        ),
        m(
            "http",
            r"Server: lighttpd/1\.5\.(\d+)",
            "lighttpd 1.5",
            Some("1.5.$1"),
        ),
        m(
            "http",
            r"Server: lighttpd/2\.0\.(\d+)",
            "lighttpd 2.0",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: lighttpd/1\.4\.(\d+) \(Debian\)",
            "lighttpd 1.4 (Debian)",
            Some("1.4.$1"),
        ),
        m(
            "http",
            r"Server: lighttpd/1\.4\.(\d+) \(Ubuntu\)",
            "lighttpd 1.4 (Ubuntu)",
            Some("1.4.$1"),
        ),
        ...
        m(
            "http",
            r"Server: LiteSpeed/6\.(\d+\.\d+)",
            "LiteSpeed 6",
            Some("6.$1"),
        ),
        m(
            "http",
            r"Server: LiteSpeed/5\.(\d+\.\d+)",
            "LiteSpeed 5",
            Some("5.$1"),
        ),
        m(
            "http",
            r"Server: LiteSpeed/4\.(\d+\.\d+)",
            "LiteSpeed 4",
            Some("4.$1"),
        ),
        m(
            "http",
            r"Server: LiteSpeed/6\.(\d+)",
            "LiteSpeed 6",
            Some("6.$1"),
        ),
        m(
            "http",
            r"Server: LiteSpeed/5\.(\d+)",
            "LiteSpeed 5",
            Some("5.$1"),
        ),
        m(
            "http",
            r"Server: OpenLiteSpeed/1\.8\.(\d+)",
            "OpenLiteSpeed 1.8",
            Some("1.8.$1"),
        ),
        m(
            "http",
            r"Server: OpenLiteSpeed/1\.7\.(\d+)",
            "OpenLiteSpeed 1.7",
            Some("1.7.$1"),
        ),
        m(
            "http",
            r"Server: OpenLiteSpeed/1\.6\.(\d+)",
            "OpenLiteSpeed 1.6",
            Some("1.6.$1"),
        ),
        m(
            "http",
            r"Server: OpenLiteSpeed/1\.4\.(\d+)",
            "OpenLiteSpeed 1.4",
            Some("1.4.$1"),
        ),
        ...
        m(
            "http",
            r"Server: openresty/1\.25\.(\d+)",
            "OpenResty 1.25",
            Some("1.25.$1"),
        ),
        m(
            "http",
            r"Server: openresty/1\.21\.(\d+)",
            "OpenResty 1.21",
            Some("1.21.$1"),
        ),
        m(
            "http",
            r"Server: openresty/1\.19\.(\d+)",
            "OpenResty 1.19",
            Some("1.19.$1"),
        ),
        m(
            "http",
            r"Server: openresty/1\.17\.(\d+)",
            "OpenResty 1.17",
            Some("1.17.$1"),
        ),
        m(
            "http",
            r"Server: openresty/1\.15\.(\d+)",
            "OpenResty 1.15",
            Some("1.15.$1"),
        ),
        m(
            "http",
            r"Server: Tengine/3\.(\d+\.\d+)",
            "Tengine 3",
            Some("3.$1"),
        ),
        m(
            "http",
            r"Server: Tengine/2\.(\d+\.\d+)",
            "Tengine 2",
            Some("2.$1"),
        ),
        ...
        m(
            "http",
            r"Server: envoy/1\.(\d+\.\d+)",
            "Envoy proxy 1",
            Some("1.$1"),
        ),
        m(
            "http",
            r"Server: envoy/1\.28\.(\d+)",
            "Envoy proxy 1.28",
            Some("1.28.$1"),
        ),
        m(
            "http",
            r"Server: envoy/1\.27\.(\d+)",
            "Envoy proxy 1.27",
            Some("1.27.$1"),
        ),
        m(
            "http",
            r"Server: envoy/1\.26\.(\d+)",
            "Envoy proxy 1.26",
            Some("1.26.$1"),
        ),
        m(
            "http",
            r"Server: envoy/1\.25\.(\d+)",
            "Envoy proxy 1.25",
            Some("1.25.$1"),
        ),
        ...
        m(
            "http",
            r"Server: gunicorn/22\.(\d+\.\d+)",
            "Gunicorn 22",
            Some("22.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/21\.(\d+\.\d+)",
            "Gunicorn 21",
            Some("21.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/20\.(\d+\.\d+)",
            "Gunicorn 20",
            Some("20.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/19\.(\d+\.\d+)",
            "Gunicorn 19",
            Some("19.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/20\.1\.(\d+)",
            "Gunicorn 20.1",
            Some("20.1.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/19\.9\.(\d+)",
            "Gunicorn 19.9",
            Some("19.9.$1"),
        ),
        // uvicorn versions
        ...
        m(
            "http",
            r"Server: Werkzeug/3\.(\d+\.\d+)",
            "Werkzeug 3",
            Some("3.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.(\d+\.\d+)",
            "Werkzeug 2",
            Some("2.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/1\.(\d+\.\d+)",
            "Werkzeug 1",
            Some("1.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/3\.0\.(\d+)",
            "Werkzeug 3.0",
            Some("3.0.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.3\.(\d+)",
            "Werkzeug 2.3",
            Some("2.3.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.2\.(\d+)",
            "Werkzeug 2.2",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.0\.(\d+)",
            "Werkzeug 2.0",
            Some("2.0.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Cherokee/1\.2\.(\d+)",
            "Cherokee 1.2",
            Some("1.2.$1"),
        ),
        m(
            "http",
            r"Server: Cherokee/1\.0\.(\d+)",
            "Cherokee 1.0",
            Some("1.0.$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: Abyss/2\.(\d+\.\d+)",
            "Abyss 2",
            Some("2.$1"),
        ),
        m(
            "http",
            r"Server: Abyss/1\.(\d+\.\d+)",
            "Abyss 1",
            Some("1.$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: Hiawatha v11\.(\d+)",
            "Hiawatha 11",
            Some("11.$1"),
        ),
        m(
            "http",
            r"Server: Hiawatha v10\.(\d+)",
            "Hiawatha 10",
            Some("10.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Microsoft-HTTPAPI/(\d+\.\d+)",
            "Microsoft HTTPAPI",
            Some("$1"),
        ),
        m(
...
pub fn more_version_specific_database_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "mysql",
            r"5\.0\.(\d+)-MySQL Community Server",
            "MySQL 5.0 Community",
            Some("5.0.$1"),
        ),
        ...
        m(
            "mysql",
            r"5\.1\.(\d+)-MySQL Community Server",
            "MySQL 5.1 Community",
            Some("5.1.$1"),
        ),
        m(
        ...
        m(
            "mysql",
            r"5\.5\.(\d+)-MySQL Community Server",
            "MySQL 5.5 Community",
            Some("5.5.$1"),
        ),
        m(
        ...
        m(
            "mysql",
            r"5\.6\.(\d+)-MySQL Community Server",
            "MySQL 5.6 Community",
            Some("5.6.$1"),
        ),
        ...
        m(
            "mysql",
            r"5\.7\.(\d+)-MySQL Community Server",
            "MySQL 5.7 Community",
            Some("5.7.$1"),
        ),
        m(
        ...
        m(
            "mysql",
            r"8\.0\.(\d+)-MySQL Community Server",
            "MySQL 8.0 Community",
            Some("8.0.$1"),
        ),
        m(
            "mysql",
            r"8\.0\.(\d+)-commercial",
            "MySQL 8.0 Commercial",
            Some("8.0.$1"),
        ),
        m(
            "mysql",
            r"8\.0\.(\d+)-MySQL Community Server - GPL",
            "MySQL 8.0 Community GPL",
            Some("8.0.$1"),
        ),
        // MySQL 8.4.x specific
        m(
            "mysql",
            r"8\.4\.(\d+)-MySQL Community Server",
            "MySQL 8.4 Community",
            Some("8.4.$1"),
        ),
        m(
            "mysql",
            r"8\.4\.(\d+)-commercial",
            "MySQL 8.4 Commercial",
            Some("8.4.$1"),
        ),
        // MySQL 9.x specific
        m(
            "mysql",
            r"9\.0\.(\d+)-MySQL Community Server",
            "MySQL 9.0 Community",
            Some("9.0.$1"),
        ),
        m(
            "mysql",
            r"9\.1\.(\d+)-MySQL Community Server",
            "MySQL 9.1 Community",
            Some("9.1.$1"),
        ),
        ...
        m(
            "mysql",
            r"10\.0\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.0 (Ubuntu)",
            Some("10.0.$1"),
        ),
        m(
            "mysql",
            r"10\.1\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.1 (Ubuntu)",
            Some("10.1.$1"),
        ),
        m(
            "mysql",
            r"10\.2\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.2 (Ubuntu)",
            Some("10.2.$1"),
        ),
        m(
            "mysql",
            r"10\.3\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.3 (Ubuntu)",
            Some("10.3.$1"),
        ),
        m(
            "mysql",
            r"10\.4\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.4 (Ubuntu)",
            Some("10.4.$1"),
        ),
        m(
            "mysql",
            r"10\.5\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.5 (Ubuntu)",
            Some("10.5.$1"),
        ),
        m(
            "mysql",
            r"10\.6\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.6 (Ubuntu)",
            Some("10.6.$1"),
        ),
        m(
            "mysql",
            r"10\.11\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 10.11 (Ubuntu)",
            Some("10.11.$1"),
        ),
        m(
            "mysql",
            r"10\.3\.(\d+)-MariaDB.*Debian",
            "MariaDB 10.3 (Debian)",
            Some("10.3.$1"),
        ),
        m(
            "mysql",
            r"10\.5\.(\d+)-MariaDB.*Debian",
            "MariaDB 10.5 (Debian)",
            Some("10.5.$1"),
        ),
        m(
            "mysql",
            r"10\.6\.(\d+)-MariaDB.*Debian",
            "MariaDB 10.6 (Debian)",
            Some("10.6.$1"),
        ),
        m(
            "mysql",
            r"10\.11\.(\d+)-MariaDB.*Debian",
            "MariaDB 10.11 (Debian)",
            Some("10.11.$1"),
        ),
        // MariaDB 11.x specific
        m(
            "mysql",
            r"11\.0\.(\d+)-MariaDB.*Ubuntu",
            "MariaDB 11.0 (Ubuntu)",
            Some("11.0.$1"),
        ),
        m(
        ...
        m(
            "postgres",
            r"PostgreSQL 10\.(\d+) \(Ubuntu\)",
            "PostgreSQL 10 (Ubuntu)",
            Some("10.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 10\.(\d+) \(Debian\)",
            "PostgreSQL 10 (Debian)",
            Some("10.$1"),
        ),
        // PostgreSQL 11.x specific
        m(
            "postgres",
            r"PostgreSQL 11\.(\d+) \(Ubuntu\)",
            "PostgreSQL 11 (Ubuntu)",
            Some("11.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 11\.(\d+) \(Debian\)",
        ...
        m(
            "postgres",
            r"PostgreSQL 12\.(\d+) \(Ubuntu\)",
            "PostgreSQL 12 (Ubuntu)",
            Some("12.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 12\.(\d+) \(Debian\)",
        ...
        m(
            "postgres",
            r"PostgreSQL 13\.(\d+) \(Ubuntu\)",
            "PostgreSQL 13 (Ubuntu)",
            Some("13.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 13\.(\d+) \(Debian\)",
            "PostgreSQL 13 (Debian)",
            Some("13.$1"),
        ),
        // PostgreSQL 14.x specific
        m(
            "postgres",
            r"PostgreSQL 14\.(\d+) \(Ubuntu\)",
            "PostgreSQL 14 (Ubuntu)",
            Some("14.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 14\.(\d+) \(Debian\)",
        ...
        m(
            "postgres",
            r"PostgreSQL 15\.(\d+) \(Ubuntu\)",
            "PostgreSQL 15 (Ubuntu)",
            Some("15.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 15\.(\d+) \(Debian\)",
            "PostgreSQL 15 (Debian)",
            Some("15.$1"),
        ),
        // PostgreSQL 16.x specific
        m(
            "postgres",
            r"PostgreSQL 16\.(\d+) \(Ubuntu\)",
            "PostgreSQL 16 (Ubuntu)",
            Some("16.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 16\.(\d+) \(Debian\)",
        ...
        m(
            "postgres",
            r"PostgreSQL 17\.(\d+) \(Ubuntu\)",
            "PostgreSQL 17 (Ubuntu)",
            Some("17.$1"),
        ),
        m(
            "postgres",
            r"PostgreSQL 17\.(\d+) \(Debian\)",
            "PostgreSQL 17 (Debian)",
            Some("17.$1"),
        ),
        // Redis specific versions
        m(
            "redis",
            r"redis_version:2\.8\.(\d+)",
            "Redis 2.8",
            Some("2.8.$1"),
        ),
        m(
            "redis",
            r"redis_version:2\.6\.(\d+)",
            "Redis 2.6",
            Some("2.6.$1"),
        ),
        m(
            "redis",
            r"redis_version:3\.0\.(\d+)",
            "Redis 3.0",
            Some("3.0.$1"),
        ),
        m(
            "redis",
            r"redis_version:3\.2\.(\d+)",
            "Redis 3.2",
            Some("3.2.$1"),
        ),
        m(
            "redis",
            r"redis_version:4\.0\.(\d+)",
            "Redis 4.0",
            Some("4.0.$1"),
        ),
        m(
            "redis",
            r"redis_version:5\.0\.(\d+)",
            "Redis 5.0",
            Some("5.0.$1"),
        ),
        m(
            "redis",
            r"redis_version:6\.0\.(\d+)",
            "Redis 6.0",
            Some("6.0.$1"),
        ),
        m(
            "redis",
            r"redis_version:6\.2\.(\d+)",
            "Redis 6.2",
            Some("6.2.$1"),
        ),
        m(
            "redis",
            r"redis_version:7\.0\.(\d+)",
            "Redis 7.0",
            Some("7.0.$1"),
        ),
        m(
            "redis",
            r"redis_version:7\.2\.(\d+)",
            "Redis 7.2",
            Some("7.2.$1"),
        ),
        m(
            "redis",
            r"redis_version:7\.4\.(\d+)",
            "Redis 7.4",
            Some("7.4.$1"),
        ),
        ...
        m(
            "elasticsearch",
            r"elasticsearch/6\.8\.(\d+)",
            "Elasticsearch 6.8",
            Some("6.8.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.0\.(\d+)",
            "Elasticsearch 7.0",
            Some("7.0.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.1\.(\d+)",
            "Elasticsearch 7.1",
            Some("7.1.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.2\.(\d+)",
            "Elasticsearch 7.2",
            Some("7.2.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.3\.(\d+)",
            "Elasticsearch 7.3",
            Some("7.3.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.4\.(\d+)",
            "Elasticsearch 7.4",
            Some("7.4.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.5\.(\d+)",
            "Elasticsearch 7.5",
            Some("7.5.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.6\.(\d+)",
            "Elasticsearch 7.6",
            Some("7.6.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.7\.(\d+)",
            "Elasticsearch 7.7",
            Some("7.7.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.8\.(\d+)",
            "Elasticsearch 7.8",
            Some("7.8.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.9\.(\d+)",
            "Elasticsearch 7.9",
            Some("7.9.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.10\.(\d+)",
            "Elasticsearch 7.10",
            Some("7.10.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.11\.(\d+)",
            "Elasticsearch 7.11",
            Some("7.11.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.12\.(\d+)",
            "Elasticsearch 7.12",
            Some("7.12.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.13\.(\d+)",
            "Elasticsearch 7.13",
            Some("7.13.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.14\.(\d+)",
            "Elasticsearch 7.14",
            Some("7.14.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.15\.(\d+)",
            "Elasticsearch 7.15",
            Some("7.15.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.16\.(\d+)",
            "Elasticsearch 7.16",
            Some("7.16.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/7\.17\.(\d+)",
            "Elasticsearch 7.17",
            Some("7.17.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.0\.(\d+)",
            "Elasticsearch 8.0",
            Some("8.0.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.1\.(\d+)",
            "Elasticsearch 8.1",
            Some("8.1.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.2\.(\d+)",
            "Elasticsearch 8.2",
            Some("8.2.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.3\.(\d+)",
            "Elasticsearch 8.3",
            Some("8.3.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.4\.(\d+)",
            "Elasticsearch 8.4",
            Some("8.4.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.5\.(\d+)",
            "Elasticsearch 8.5",
            Some("8.5.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.6\.(\d+)",
            "Elasticsearch 8.6",
            Some("8.6.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.7\.(\d+)",
            "Elasticsearch 8.7",
            Some("8.7.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.8\.(\d+)",
            "Elasticsearch 8.8",
            Some("8.8.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.9\.(\d+)",
            "Elasticsearch 8.9",
            Some("8.9.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.10\.(\d+)",
            "Elasticsearch 8.10",
            Some("8.10.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.11\.(\d+)",
            "Elasticsearch 8.11",
            Some("8.11.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.12\.(\d+)",
            "Elasticsearch 8.12",
            Some("8.12.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.13\.(\d+)",
            "Elasticsearch 8.13",
            Some("8.13.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.14\.(\d+)",
            "Elasticsearch 8.14",
            Some("8.14.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.15\.(\d+)",
            "Elasticsearch 8.15",
            Some("8.15.$1"),
        ),
        m(
            "elasticsearch",
            r"elasticsearch/8\.16\.(\d+)",
            "Elasticsearch 8.16",
            Some("8.16.$1"),
        ),
    ]
...
pub fn more_version_specific_language_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"X-Powered-By: Python/3\.13\.(\d+)",
            "Python 3.13",
            Some("3.13.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Python/3\.12\.(\d+)",
            "Python 3.12",
            Some("3.12.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Python/3\.11\.(\d+)",
            "Python 3.11",
            Some("3.11.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Python/3\.10\.(\d+)",
            "Python 3.10",
            Some("3.10.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Python/3\.9\.(\d+)",
            "Python 3.9",
            Some("3.9.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Python/3\.8\.(\d+)",
            "Python 3.8",
            Some("3.8.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Node\.js/v22\.(\d+\.\d+)",
            "Node.js 22",
            Some("22.$1"),
        ),
        m(
            "http",
            r"Server: Node\.js/v20\.(\d+\.\d+)",
            "Node.js 20",
            Some("20.$1"),
        ),
        m(
            "http",
            r"Server: Node\.js/v18\.(\d+\.\d+)",
            "Node.js 18",
            Some("18.$1"),
        ),
        m(
            "http",
            r"Server: Node\.js/v16\.(\d+\.\d+)",
            "Node.js 16",
            Some("16.$1"),
        ),
        m(
            "http",
            r"Server: Node\.js/v14\.(\d+\.\d+)",
            "Node.js 14",
            Some("14.$1"),
        ),
        m(
            "http",
            r"Server: Node\.js/v12\.(\d+\.\d+)",
            "Node.js 12",
            Some("12.$1"),
        ),
        ...
        m(
            "http",
            r"Server: node/v22\.(\d+\.\d+)",
            "Node.js 22",
            Some("22.$1"),
        ),
        m(
            "http",
            r"Server: node/v20\.(\d+\.\d+)",
            "Node.js 20",
            Some("20.$1"),
        ),
        m(
            "http",
            r"Server: node/v18\.(\d+\.\d+)",
            "Node.js 18",
            Some("18.$1"),
        ),
        m(
            "http",
            r"Server: node/v16\.(\d+\.\d+)",
            "Node.js 16",
            Some("16.$1"),
        ),
        ...
        m(
            "http",
            r"X-Powered-By: Ruby/3\.3\.(\d+)",
            "Ruby 3.3",
            Some("3.3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Ruby/3\.2\.(\d+)",
            "Ruby 3.2",
            Some("3.2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Ruby/3\.1\.(\d+)",
            "Ruby 3.1",
            Some("3.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Ruby/3\.0\.(\d+)",
            "Ruby 3.0",
            Some("3.0.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Ruby/2\.7\.(\d+)",
            "Ruby 2.7",
            Some("2.7.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Java/21\.(\d+\.\d+)",
            "Java 21",
            Some("21.$1"),
        ),
        m(
            "http",
            r"Server: Java/17\.(\d+\.\d+)",
            "Java 17",
            Some("17.$1"),
        ),
        m(
            "http",
            r"Server: Java/11\.(\d+\.\d+)",
            "Java 11",
            Some("11.$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Java/21\.(\d+\.\d+)",
            "Java 21",
            Some("21.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Java/17\.(\d+\.\d+)",
            "Java 17",
            Some("17.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Java/11\.(\d+\.\d+)",
            "Java 11",
            Some("11.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Java/8\.(\d+\.\d+)",
            "Java 8",
            Some("8.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Go-httpd/1\.22\.(\d+)",
            "Go 1.22 httpd",
            Some("1.22.$1"),
        ),
        m(
            "http",
            r"Server: Go-httpd/1\.21\.(\d+)",
            "Go 1.21 httpd",
            Some("1.21.$1"),
        ),
        m(
            "http",
            r"Server: Go-httpd/1\.20\.(\d+)",
            "Go 1.20 httpd",
            Some("1.20.$1"),
        ),
        m(
            "http",
            r"Server: Go-httpd/1\.19\.(\d+)",
            "Go 1.19 httpd",
            Some("1.19.$1"),
        ),
        m(
            "http",
            r"Server: Go-httpd/1\.18\.(\d+)",
            "Go 1.18 httpd",
            Some("1.18.$1"),
        ),
        ...
        m(
            "http",
            r"Server: actix-web/4\.(\d+\.\d+)",
            "Rust actix-web 4",
            Some("4.$1"),
        ),
        m(
            "http",
            r"Server: actix-web/3\.(\d+\.\d+)",
            "Rust actix-web 3",
            Some("3.$1"),
        ),
        m(
            "http",
            r"Server: actix-web/2\.(\d+\.\d+)",
            "Rust actix-web 2",
            Some("2.$1"),
        ),
        m(
            "http",
            r"Server: actix-web/1\.(\d+\.\d+)",
            "Rust actix-web 1",
            Some("1.$1"),
        ),
        m(
            "http",
            r"Server: Rocket/0\.5\.(\d+)",
            "Rust Rocket 0.5",
            Some("0.5.$1"),
        ),
        m(
            "http",
            r"Server: Rocket/0\.4\.(\d+)",
            "Rust Rocket 0.4",
            Some("0.4.$1"),
        ),
        m(
        ...
        m(
            "http",
            r"Server: hyper/1\.(\d+\.\d+)",
            "Rust hyper 1",
            Some("1.$1"),
        ),
        m(
            "http",
            r"Server: hyper/0\.14\.(\d+)",
            "Rust hyper 0.14",
            Some("0.14.$1"),
        ),
    ]
...
pub fn more_version_specific_framework_signatures() -> Vec<MatchPattern> {
    vec![
        ...
        m(
            "http",
            r"Server: Django/5\.1\.(\d+)",
            "Django 5.1",
            Some("5.1.$1"),
        ),
        m(
            "http",
            r"Server: Django/5\.0\.(\d+)",
            "Django 5.0",
            Some("5.0.$1"),
        ),
        m(
        ...
        m(
            "http",
            r"X-Powered-By: Express/4\.21\.(\d+)",
            "Express.js 4.21",
            Some("4.21.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Express/4\.20\.(\d+)",
            "Express.js 4.20",
            Some("4.20.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Express/4\.19\.(\d+)",
            "Express.js 4.19",
            Some("4.19.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Express/4\.18\.(\d+)",
            "Express.js 4.18",
            Some("4.18.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Express/4\.17\.(\d+)",
            "Express.js 4.17",
            Some("4.17.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Express/4\.16\.(\d+)",
            "Express.js 4.16",
            Some("4.16.$1"),
        ),
        m(
            "http",
            r"Server: Express/4\.21\.(\d+)",
            "Express.js 4.21",
            Some("4.21.$1"),
        ),
        m(
            "http",
            r"Server: Express/4\.20\.(\d+)",
            "Express.js 4.20",
            Some("4.20.$1"),
        ),
        m(
            "http",
            r"Server: Express/4\.18\.(\d+)",
            "Express.js 4.18",
            Some("4.18.$1"),
        ),
        m(
            "http",
            r"Server: Express/4\.17\.(\d+)",
            "Express.js 4.17",
            Some("4.17.$1"),
        ),
        ...
        m(
            "http",
            r"X-Powered-By: Rails/7\.2\.(\d+)",
            "Ruby on Rails 7.2",
            Some("7.2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Rails/7\.1\.(\d+)",
            "Ruby on Rails 7.1",
            Some("7.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Rails/7\.0\.(\d+)",
            "Ruby on Rails 7.0",
            Some("7.0.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Rails/6\.1\.(\d+)",
            "Ruby on Rails 6.1",
            Some("6.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Rails/6\.0\.(\d+)",
            "Ruby on Rails 6.0",
            Some("6.0.$1"),
        ),
        m(
            "http",
            r"Server: Puma.*Rails/7\.2",
            "Ruby on Rails 7.2 (Puma)",
            None,
        ),
        m(
            "http",
            r"Server: Puma.*Rails/7\.1",
            "Ruby on Rails 7.1 (Puma)",
            None,
        ),
        m(
            "http",
            r"Server: Puma.*Rails/7\.0",
            "Ruby on Rails 7.0 (Puma)",
            None,
        ),
        m(
            "http",
            r"Server: Puma.*Rails/6\.1",
            "Ruby on Rails 6.1 (Puma)",
            None,
        ),
        m(
            "http",
            r"Server: Puma.*Rails/6\.0",
            "Ruby on Rails 6.0 (Puma)",
            None,
        ),
        // Laravel specific versions
        m(
            "http",
            r"X-Powered-By: Laravel/11\.(\d+)",
            "Laravel 11",
            Some("11.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Laravel/10\.(\d+)",
            "Laravel 10",
            Some("10.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Laravel/9\.(\d+)",
            "Laravel 9",
            Some("9.$1"),
        ),
        m(
            "http",
            r"Server: Laravel/11\.(\d+)",
            "Laravel 11",
            Some("11.$1"),
        ),
        m(
            "http",
            r"Server: Laravel/10\.(\d+)",
            "Laravel 10",
            Some("10.$1"),
        ),
        m(
            "http",
            r"Server: Laravel/9\.(\d+)",
            "Laravel 9",
            Some("9.$1"),
        ),
        ...
        m(
            "http",
            r"X-Powered-By: Spring Boot/3\.3\.(\d+)",
            "Spring Boot 3.3",
            Some("3.3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/3\.2\.(\d+)",
            "Spring Boot 3.2",
            Some("3.2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/3\.1\.(\d+)",
            "Spring Boot 3.1",
            Some("3.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/3\.0\.(\d+)",
            "Spring Boot 3.0",
            Some("3.0.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.7\.(\d+)",
            "Spring Boot 2.7",
            Some("2.7.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.6\.(\d+)",
            "Spring Boot 2.6",
            Some("2.6.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.5\.(\d+)",
            "Spring Boot 2.5",
            Some("2.5.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.4\.(\d+)",
            "Spring Boot 2.4",
            Some("2.4.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.3\.(\d+)",
            "Spring Boot 2.3",
            Some("2.3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.2\.(\d+)",
            "Spring Boot 2.2",
            Some("2.2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.1\.(\d+)",
            "Spring Boot 2.1",
            Some("2.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Spring Boot/2\.0\.(\d+)",
            "Spring Boot 2.0",
            Some("2.0.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Kestrel.*ASP\.NET Core/8\.0",
            "ASP.NET Core 8.0",
            None,
        ),
        m(
            "http",
            r"Server: Kestrel.*ASP\.NET Core/7\.0",
            "ASP.NET Core 7.0",
            None,
        ),
        m(
            "http",
            r"Server: Kestrel.*ASP\.NET Core/6\.0",
            "ASP.NET Core 6.0",
            None,
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET Core/8\.0",
            "ASP.NET Core 8.0",
            None,
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET Core/7\.0",
            "ASP.NET Core 7.0",
            None,
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET Core/6\.0",
            "ASP.NET Core 6.0",
            None,
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET Core/8\.0\.(\d+)",
            "ASP.NET Core 8.0",
            Some("8.0.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET Core/7\.0\.(\d+)",
            "ASP.NET Core 7.0",
            Some("7.0.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: ASP\.NET Core/6\.0\.(\d+)",
            "ASP.NET Core 6.0",
            Some("6.0.$1"),
        ),
        ...
        m(
            "http",
            r"X-Powered-By: Symfony/7\.(\d+\.\d+)",
            "Symfony 7",
            Some("7.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Symfony/6\.(\d+\.\d+)",
            "Symfony 6",
            Some("6.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Symfony/5\.(\d+\.\d+)",
            "Symfony 5",
            Some("5.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Symfony/4\.(\d+\.\d+)",
            "Symfony 4",
            Some("4.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Symfony/7\.2\.(\d+)",
            "Symfony 7.2",
            Some("7.2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Symfony/7\.1\.(\d+)",
            "Symfony 7.1",
            Some("7.1.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Symfony/6\.4\.(\d+)",
            "Symfony 6.4",
            Some("6.4.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Symfony/5\.4\.(\d+)",
            "Symfony 5.4",
            Some("5.4.$1"),
        ),
        ...
        m(
            "http",
            r"X-Powered-By: Next\.js/15\.(\d+\.\d+)",
            "Next.js 15",
            Some("15.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Next\.js/14\.(\d+\.\d+)",
            "Next.js 14",
            Some("14.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Next\.js/13\.(\d+\.\d+)",
            "Next.js 13",
            Some("13.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Next\.js/12\.(\d+\.\d+)",
            "Next.js 12",
            Some("12.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Next\.js/11\.(\d+\.\d+)",
            "Next.js 11",
            Some("11.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Next\.js/10\.(\d+\.\d+)",
            "Next.js 10",
            Some("10.$1"),
        ),
        ...
        m(
            "http",
            r"X-Powered-By: Nuxt/3\.(\d+\.\d+)",
            "Nuxt.js 3",
            Some("3.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Nuxt/2\.(\d+\.\d+)",
            "Nuxt.js 2",
            Some("2.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Nuxt/3\.14\.(\d+)",
            "Nuxt.js 3.14",
            Some("3.14.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Nuxt/3\.13\.(\d+)",
            "Nuxt.js 3.13",
            Some("3.13.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Nuxt/3\.12\.(\d+)",
            "Nuxt.js 3.12",
            Some("3.12.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Nuxt/2\.17\.(\d+)",
            "Nuxt.js 2.17",
            Some("2.17.$1"),
        ),
        m(
            "http",
            r"X-Powered-By: Nuxt/2\.15\.(\d+)",
            "Nuxt.js 2.15",
            Some("2.15.$1"),
        ),
        ...
        m(
            "http",
            r"X-Remix-Version: 2\.(\d+\.\d+)",
            "Remix 2",
            Some("2.$1"),
        ),
        m(
            "http",
            r"X-Remix-Version: 1\.(\d+\.\d+)",
            "Remix 1",
            Some("1.$1"),
        ),
        ...
        m(
            "http",
            r"Server: uvicorn/0\.32\.(\d+)",
            "uvicorn 0.32",
            Some("0.32.$1"),
        ),
        m(
            "http",
            r"Server: uvicorn/0\.31\.(\d+)",
            "uvicorn 0.31",
            Some("0.31.$1"),
        ),
        m(
            "http",
            r"Server: uvicorn/0\.30\.(\d+)",
            "uvicorn 0.30",
            Some("0.30.$1"),
        ),
        m(
            "http",
            r"Server: uvicorn/0\.29\.(\d+)",
            "uvicorn 0.29",
            Some("0.29.$1"),
        ),
        m(
            "http",
            r"Server: uvicorn/0\.27\.(\d+)",
            "uvicorn 0.27",
            Some("0.27.$1"),
        ),
        m(
            "http",
            r"Server: uvicorn/0\.24\.(\d+)",
            "uvicorn 0.24",
            Some("0.24.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Werkzeug/3\.0\.(\d+) Python/3\.13",
            "Flask (Python 3.13)",
            Some("3.0.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/3\.0\.(\d+) Python/3\.12",
            "Flask (Python 3.12)",
            Some("3.0.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/3\.0\.(\d+) Python/3\.11",
            "Flask (Python 3.11)",
            Some("3.0.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.3\.(\d+) Python/3\.11",
            "Flask (Python 3.11)",
            Some("2.3.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.3\.(\d+) Python/3\.10",
            "Flask (Python 3.10)",
            Some("2.3.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.3\.(\d+) Python/3\.9",
            "Flask (Python 3.9)",
            Some("2.3.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.0\.(\d+) Python/3\.10",
            "Flask (Python 3.10)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.0\.(\d+) Python/3\.9",
            "Flask (Python 3.9)",
            Some("2.0.$1"),
        ),
        m(
            "http",
            r"Server: Werkzeug/2\.0\.(\d+) Python/3\.8",
            "Flask (Python 3.8)",
            Some("2.0.$1"),
        ),
        ...
        m(
            "http",
            r"Server: Werkzeug.*Django/5\.1",
            "Django 5.1 (debug)",
            None,
        ),
        m(
            "http",
            r"Server: Werkzeug.*Django/5\.0",
            "Django 5.0 (debug)",
            None,
        ),
        m(
            "http",
            r"Server: Werkzeug.*Django/4\.2",
            "Django 4.2 (debug)",
            None,
        ),
        m(
            "http",
            r"Server: Werkzeug.*Django/4\.1",
            "Django 4.1 (debug)",
            None,
        ),
        // Puma versions
        ...
        m(
            "http",
            r"Server: unicorn/6\.(\d+\.\d+)",
            "Unicorn 6",
            Some("6.$1"),
        ),
        m(
            "http",
            r"Server: unicorn/5\.(\d+\.\d+)",
            "Unicorn 5",
            Some("5.$1"),
        ),
        ...
        m(
            "http",
            r"Server: gunicorn/22\.0\.(\d+).*Python/3\.13",
            "Gunicorn (Python 3.13)",
            Some("22.0.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/22\.0\.(\d+).*Python/3\.12",
            "Gunicorn (Python 3.12)",
            Some("22.0.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/21\.2\.(\d+).*Python/3\.12",
            "Gunicorn (Python 3.12)",
            Some("21.2.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/21\.2\.(\d+).*Python/3\.11",
            "Gunicorn (Python 3.11)",
            Some("21.2.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/20\.1\.(\d+).*Python/3\.11",
            "Gunicorn (Python 3.11)",
            Some("20.1.$1"),
        ),
        m(
            "http",
            r"Server: gunicorn/20\.1\.(\d+).*Python/3\.10",
            "Gunicorn (Python 3.10)",
            Some("20.1.$1"),
        ),
        // SvelteKit versions
        m(
            "http",
            r"X-Powered-By: SvelteKit/(\d+\.\d+\.\d+)",
            "SvelteKit",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: SvelteKit/(\d+\.\d+\.\d+)",
            "SvelteKit",
            Some("$1"),
        ),
        // Remix with versions
        m(
            "http",
            r"Server: Remix/(\d+\.\d+\.\d+)",
            "Remix",
            Some("$1"),
        ),
        m(
            "http",
            r"X-Remix-Version: (\d+\.\d+\.\d+)",
            "Remix",
            Some("$1"),
        ),
        // Hapi.js versions
        ...
        m(
            "http",
            r"X-Powered-By: Phoenix/(\d+\.\d+\.\d+)",
            "Phoenix",
            Some("$1"),
        ),
        m(
            "http",
            r"Server: Phoenix/(\d+\.\d+\.\d+)",
            "Phoenix",
            Some("$1"),
        ),
        // Akka HTTP versions
        m(
            "http",
            r"Server: Akka HTTP/10\.(\d+\.\d+)",
            "Akka HTTP 10",
            Some("10.$1"),
        ),
        m(
            "http",
            r"Server: Akka HTTP/10\.2\.(\d+)",
            "Akka HTTP 10.2",
            Some("10.2.$1"),
        ),
        m(
            "http",
            r"Server: Akka HTTP/10\.1\.(\d+)",
            "Akka HTTP 10.1",
            Some("10.1.$1"),
        ),
        // Ktor versions
...
mod tests {
    ...
    fn test_http_signatures_count() {
        ...
        assert!(
            sigs.len() >= 30,
            "Expected at least 30 HTTP signatures, got {}",
            sigs.len()
        );
    }
    ...
    fn test_ssh_signatures_count() {
        ...
        assert!(
            sigs.len() >= 15,
            "Expected at least 15 SSH signatures, got {}",
            sigs.len()
        );
    }
    ...
    fn test_ftp_signatures_count() {
        ...
        assert!(
            sigs.len() >= 15,
            "Expected at least 15 FTP signatures, got {}",
            sigs.len()
        );
    }
    ...
    fn test_smtp_signatures_count() {
        ...
        assert!(
            sigs.len() >= 10,
            "Expected at least 10 SMTP signatures, got {}",
            sigs.len()
        );
    }
    ...
    fn test_all_signatures_count() {
        ...
        assert!(
            sigs.len() >= 3000,
            "Expected at least 3000 total signatures, got {}",
            sigs.len()
        );
    }
