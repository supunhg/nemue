...
impl WordlistManager {
    ...
    fn get_common_dirs_1k(&self) -> Vec<String> {
        vec![
            ...
            "images", "img", "css", "js", "javascript", "static", "assets", "media",
            "upload", "uploads", "files", "download", "downloads", "backup", "backups",
            "temp", "tmp", "test", "demo", "dev", "development", "prod", "production",
            "api", "v1", "v2", "v3", "rest", "graphql", "webhooks",
            "user", "users", "account", "accounts", "profile", "profiles",
            "blog", "news", "posts", "post", "article", "articles",
            "dashboard", "panel", "cp", "cpanel", "control", "manager",
            "config", "configuration", "settings", "setup", "install", "installation",
            "docs", "documentation", "help", "support", "faq",
            "search", "find", "query", "results",
            "auth", "authentication", "oauth", "signin", "signup", "register",
            "cart", "checkout", "shop", "store", "catalog", "products",
            "about", "contact", "privacy", "terms", "legal", "policy",
            "forum", "forums", "community", "discuss", "discussion",
            "mail", "email", "webmail", "smtp", "pop3", "imap",
            "db", "database", "mysql", "pgsql", "postgres", "mongo",
            "cache", "redis", "memcache", "memcached",
            "log", "logs", "access", "error", "debug",
            "cgi-bin", "bin", "scripts", "tools", "utils", "utilities",
            "old", "new", "v1", "v2", "2023", "2024", "2025",
    ...
    fn get_common_dirs_10k(&self) -> Vec<String> {
        ...
        let additional = vec![
            ...
            "phpmyadmin", "pma", "adminer", "sqlbuddy",
            "wp-json", "xmlrpc.php", "readme.html", "license.txt",
            "robots.txt", "sitemap.xml", "sitemap.txt",
            "crossdomain.xml", "clientaccesspolicy.xml",
            "WEB-INF", "META-INF", "classes", "lib", "libs",
            "vendor", "node_modules", "bower_components",
            "public", "private", "protected", "secret", "hidden",
            "data", "app", "application", "applications",
            "portal", "portals", "site", "sites", "web", "www",
        ];
    ...
    fn get_common_files(&self) -> Vec<String> {
        vec![
            ...
            ".htaccess", ".htpasswd", ".gitignore", ".gitattributes",
            "web.config", "app.config", "settings.json", "appsettings.json",
            ...
            "login.php", "admin.php", "dashboard.php", "panel.php",
            ...
            "configuration.php", "config.inc", "settings.php",
    ...
    fn get_common_extensions(&self) -> Vec<String> {
        vec![
            "php", "asp", "aspx", "jsp", "jspx", "py", "rb", "cgi", "pl",
            "html", "htm", "xml", "json", "txt", "log", "bak", "old", "tmp",
            "sql", "db", "sqlite", "mdb", "dbf",
            "zip", "tar", "gz", "bz2", "rar", "7z",
            "pdf", "doc", "docx", "xls", "xlsx", "ppt", "pptx",
            "jpg", "jpeg", "png", "gif", "svg", "ico",
            "css", "js", "ts", "vue", "jsx", "tsx",
            "swf", "fla", "swp",
    ...
    fn get_common_parameters(&self) -> Vec<String> {
        vec![
            ...
            "search", "query", "q", "s", "keyword", "keywords",
            "page", "p", "offset", "limit", "count", "size",
            "sort", "order", "orderby", "sortby", "direction",
            "filter", "filters", "category", "cat", "tag", "tags",
            "lang", "language", "locale", "region", "country",
            "format", "type", "view", "mode", "action",
            "file", "path", "url", "redirect", "return", "callback",
            "debug", "test", "dev", "development", "verbose",
            "start", "end", "from", "to", "since", "until",
            "name", "title", "description", "content", "body",
            "status", "state", "enabled", "disabled", "active",
        ].iter().map(|s| s.to_string()).collect()
    }
    ...
    fn get_joomla_paths(&self) -> Vec<String> {
        vec![
            ...
            "language", "libraries", "cache", "tmp", "logs",
            "configuration.php", "htaccess.txt", "web.config.txt",
            "README.txt", "LICENSE.txt", "joomla.xml",
        ].iter().map(|s| s.to_string()).collect()
    }
    ...
    fn get_laravel_paths(&self) -> Vec<String> {
        vec![
            ...
            "artisan", ".env", ".env.example", "composer.json", "package.json",
            "storage/logs", "storage/framework", "storage/app",
            "public/index.php", "public/robots.txt", "public/favicon.ico",
        ].iter().map(|s| s.to_string()).collect()
    }
    ...
    fn get_api_endpoints(&self) -> Vec<String> {
        vec![
            ...
            "api/products", "api/items", "api/posts", "api/articles",
            ...
            "openapi.json", "swagger.json", "api.yaml",
        ].iter().map(|s| s.to_string()).collect()
    }
}
